...
|---|---|---|---|---|---|
| TD-S0-002 | 因子验证模块仅完成最小 Gate，完整因子有效性验证仍未实现 | P1 | Validation 统计解释力不足，影响 S2b 后续质量门可信度 | S2b | ⏳ 待处理 |
...
| TD-S2-009 | IRS/PAS 当前使用最小启发式评分，未接入完整行业映射与收益校准 | P2 | 分数可运行但策略语义偏弱，可能放大 S2b 集成偏差 | S2b | ⏳ 待处理 |
