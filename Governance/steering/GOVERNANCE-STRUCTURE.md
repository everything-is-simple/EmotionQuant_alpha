...
| 命名契约 Schema 看哪里 | `docs/naming-contracts.schema.json` |
| 命名契约术语与联动模板看哪里 | `docs/naming-contracts-glossary.md` + `Governance/steering/NAMING-CONTRACT-CHANGE-TEMPLATE.md` |
